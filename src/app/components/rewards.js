      ...
      <Grid>
        <Column span={8} offset={2}>
          <Box className="try-now-text" textAlign="center">
            <h1>Join and Save with our Rewards Program</h1>
            <p>
              "Earn Smiles every time you shop, unlock member only offers and
              discounts, and pick a free Cookie on your birthday!"
            </p>
